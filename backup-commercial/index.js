 ...
 * 商业企业（商品流通企业）教学任务入口
 *
 * 商业企业特点：纯进销存，无生产成本核算，大量增值税发票业务
 * 会计准则依据：《企业会计准则第14号——收入》（财会[2017]22号）
 *
 * 知识点标签（10类）：
 * 商品采购、商品销售、仓存管理、往来管理、资金管理、费用管理、工资社保、税费、期末、出纳
 */
...
export function getCommercialTutorials(month) {
  return MONTHS[month] || []
}

export function getCommercialAllMonths() {
  return Object.keys(MONTHS)
}

export function getCommercialMonthLabels() {
