...
const tasks = [
      ...
      { type: 'text', label: '企业所得税预缴申报表', docTitle: '企业所得税季度预缴纳税申报表（A类）摘要', content: '税款所属期：2026年第四季度（10-12月）\n\n利润总额：14,859元\n税率：25%\n应纳所得税额：3,714.75元\n\n本期实际应补（退）所得税额：3,714.75元\n\n申报日期：2026-11-26', stampText: '电子税务局 已申报' }]},
  {
    ...
    entries: [
      { subjectCode: '6001', debit: 210000, credit: 0, summary: '结转主营业务收入', explanation: '主营业务收入结转至本年利润。收入类科目期末余额转出，余额归零。本月收入合计：100,000+90,000+20,000=210,000元。' },
      { subjectCode: '6401', debit: 0, credit: 105000, summary: '结转主营业务成本', explanation: '主营业务成本转出105,000元，余额归零。含第一批95,000元+第二批10,000元。' },
      { subjectCode: '6403', debit: 0, credit: 741, summary: '结转税金及附加', explanation: '税金及附加转出741元，余额归零。含城建税518.70元+教育费附加222.30元。' },
      { subjectCode: '6601', debit: 0, credit: 34800, summary: '结转销售费用', explanation: '销售费用转出41,000元，余额归零。含广告费8,000+工资25,000+社保6,250+公积金1,750。' },
      { subjectCode: '660101', debit: 0, credit: 8000, summary: '结转660101', explanation: '660101转出，余额归零。' },
      { subjectCode: '6602', debit: 0, credit: 13400, summary: '结转管理费用', explanation: '管理费用转出48,400元，余额归零。含折旧2,200+工资35,000+社保8,750+公积金2,450。' },
      { subjectCode: '660203', debit: 0, credit: 35000, summary: '结转660203', explanation: '660203转出，余额归零。' },
      { subjectCode: '6801', debit: 0, credit: 3714.75, summary: '结转所得税费用', explanation: '所得税费用转出3,714.75元，余额归零。所得税费用是损益类科目，期末结转至本年利润。' },
      { subjectCode: '4103', debit: 0, credit: 9344.25, summary: '结转费用类科目', explanation: '本年利润减少记借方。将本期所有费用转入本年利润。主营业务成本105,000+税金及附加741+销售费用41,000+管理费用48,400+所得税费用3,714.75=198,855.75元。本月净利润=210,000-198,855.75=11,144.25元。' }
    ],
    documents: [
