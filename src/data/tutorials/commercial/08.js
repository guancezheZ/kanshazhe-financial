...
返利期间：2026年7月-9月（第三季度·预结算）

预返利计算：
  上半年月均采购额：约 200,000元
  第三季度预估采购额：约 600,000元
  返利比例：1%
  预返利金额：6,000.00元

说明：按上半年采购额预估，季度末根据实际采购额结算调整

供应商确认：鑫鑫食品（盖章）✓认：鑫鑫食品（签章）` }]},
        ...
        items: [{ name: 'A4打印纸（3包）', qty: 3, price: 200, amount: 600 }, { name: '打印机墨盒（HP）', qty: 2, price: 400, amount: 800 }, { name: '文具（笔/胶带/剪刀）', qty: 1, price: 400, amount: 400 }] }]},
  {
    ...
    documents: [
      { type: 'text', label: '工资计算表', docTitle: '万悦超市2026年8月工资计算表', stampText: '人事部专用章',
        content: `2026年8月工资计算表（开学季）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

管理人员（4人）：
  店长/副店长/财务/行政：30,000.00元
...
一线员工（5人）：
  收银员3人+生鲜技工2人：23,000.00元

合计：78,000.00元
  其中管理费用：30,000.00元
  其中销售费用：48,000.00元00元` }]},
  {
    date: '2026-08-22',
    role: 'accountant',
    title: '发放8月工资',
