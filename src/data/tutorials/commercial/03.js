...
const tasks = [
      ...
      { type: 'receipt', label: '水费发票', date: '2026-03-15', totalAmount: 1100, items: [{ name: '3月水费', qty: 1, price: 1100, amount: 1100 }] }]},
  {
    ...
    tags: ['资产', "info"],
    difficulty: 2,
    description: '计提3月折旧：货架500+收银系统333.33+冷藏柜266.67+空调250=1,350元，计入管理费用-折旧费。',
    tip: '固定资产按月计提折旧。借：管理费用-折旧费，贷：累计折旧。',
    entries: [{ subjectCode: '660205', summary: '计提3月折旧', debit: 1350, credit: 0, explanation: '管理费用-折旧费增加。货架500+收银系统333.33+冷藏柜266.67+空调250=1,350元。' }, { subjectCode: '1602', summary: '计提3月折旧', debit: 0, credit: 1350, explanation: '累计折旧增加。累计折旧累计至2,700元。' }],
    documents: [
