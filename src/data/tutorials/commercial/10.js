...
const tasks = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    tags: ['商品销售', '费用管理'],
    difficulty: 3,
    description: '公司推出会员积分计划：每消费10元积1分，每1分可在下次消费时抵扣0.50元。今日客户消费含税销售额22,600元（收入20,000元，增值税2,600元），应赠送积分2,260分，预计可兑换率80%，预计兑换积分价值=2,260×0.50×80%=904元。将部分收入确认为合同负债（递延收益）。',
    tip: '积分兑换的会计处理——递延收益法：根据《企业会计准则第14号——收入》第三十五条，客户奖励积分应作为一项单独的履约义务，将交易价格在商品和积分之间按公允价值比例分摊。本例简化：积分价值=预计兑换积分×每分价值=2,260×0.50×80%=904元。分录：借：银行存款22,600，贷：主营业务收入19,096（20,000-904）、应交税费-销项2,600、合同负债904。待客户实际兑换积分时再确认收入。',
    entries: [
      { subjectCode: '100201', summary: '会员消费收款（含积分）', debit: 22600, credit: 0, explanation: '银行存款增加记借方。客户消费含税销售额22,600元全额收款。其中积分兑换义务对应的价值904元暂不确认收入。' , cashFlowItem: 'cf-op', cashFlowExplanation: '销售商品/提供劳务收到的现金（配对科目6001），属于经营活动现金流入——主营业务产生的现金收入。'},
      { subjectCode: '6001', summary: '商品销售收入（扣除积分价值）', debit: 0, credit: 19096, explanation: '主营业务收入增加记贷方。销售商品收入=20,000-904=19,096元。将积分对应的公允价值904元从收入中分离出来确认为合同负债。依据《企业会计准则第14号——收入》第三十五条：对于附有客户额外购买选择权的销售，企业应当评估该选择权是否向客户提供了一项重大权利。积分兑换属于提供重大权利，应作为单独履约义务。' },
      { subjectCode: '222101', summary: '会员消费增值税销项税额', debit: 0, credit: 2600, explanation: '应交税费-应交增值税（销项税额）增加记贷方。增值税按全额20,000×13%=2,600元计算，积分兑换不影响增值税计算。' },
      { subjectCode: '2241', summary: '积分兑换递延收益', debit: 0, credit: 904, explanation: '合同负债（其他应付款）增加记贷方。积分兑换义务904元确认为合同负债，待客户实际兑换积分时再转入收入。积分有效期一般为1年，到期未兑换的积分转入主营业务收入。' }],
    documents: [
      { type: 'invoice', label: '增值税普通发票', region: '上海', invoiceNo: '3100234598', date: '2026-10-18', buyer: '张三（会员）', seller: '本公司',
        lineItems: [{ name: '商品销售', spec: '积分赠送中', unit: '批', qty: 1, price: 20000, amount: 20000 }],
      ...
      { type: 'text', label: '积分计算表', docTitle: '会员积分计算及递延收益确认表', content: '消费金额：22,600元（含税）\n赠送积分：22,600÷10=2,260分\n每分价值：0.50元\n预计兑换率：80%\n预计兑换积分价值：2,260×0.50×80%=904元\n递延收益确认金额：904元\n\n依据：《企业会计准则第14号——收入》第三十五条', stampText: '财务专用章' }]},
  {
    ...
    tags: ['商品销售'],
    difficulty: 3,
    description: '会员张先生用积累的1,000积分兑换了一件礼品（采购成本120元），积分抵扣价值=1,000×0.50=500元。将对应比例的合同负债（递延收益）500元确认为主营业务收入。',
    tip: '客户实际兑换积分时，将对应的合同负债转入主营业务收入。分录：借：合同负债，贷：主营业务收入。注意：兑换时只确认收入，不涉及增值税（积分兑换不产生增值税纳税义务）。兑换的礼品如为外购商品，需在兑换时同步结转成本（本例简化处理）。依据《企业会计准则第14号——收入》应用指南。',
    entries: [
      { subjectCode: '2241', summary: '积分兑换转出递延收益', debit: 500, credit: 0, explanation: '合同负债（递延收益）减少记借方。会员使用1,000积分兑换礼品，将对应的递延收益500元转出。积分兑换时不再产生增值税纳税义务。' },
      { subjectCode: '6001', summary: '积分兑换确认收入', debit: 0, credit: 500, explanation: '主营业务收入增加记贷方。客户实际兑换积分时，递延收益转入主营业务收入500元。兑换时确认的收入不涉及增值税（增值税已在初始销售时全额计缴）。' }],
    documents: [
      { type: 'receipt', label: '积分兑换单', docTitle: '会员积分兑换记录', date: '2026-10-18', totalAmount: 500, stampText: '会员中心',
        items: [{ name: '会员张先生积分兑换礼品（消耗1,000分）', qty: 1, price: 500, amount: 500 }] },
      { type: 'text', label: '积分兑换说明', docTitle: '积分兑换确认说明', content: '会员姓名：张先生\n会员卡号：VIP20260001\n本次兑换积分：1,000分\n积分价值：1,000×0.50=500元\n兑换礼品：精美礼品一份\n\n剩余积分：1,260分（可继续使用）\n积分有效期：至2027年10月17日', stampText: '会员中心专用章' }]},
      ...
      { type: 'text', label: '税金计算表', docTitle: '2026年10月附加税费计算表', content: '计税依据：\n销项税额合计：39,598元\n进项税额合计：11,440元\n进项税额转出：104元\n应交增值税：39,598-11,440+104=28,262元\n\n城市维护建设税：28,262×7%=1,978.34元\n教育费附加：28,262×3%=847.86元\n合计：2,826.20元', stampText: '财务专用章' }]},
  {
    ...
    entries: [
      { subjectCode: '6001', debit: 333196, credit: 0, summary: '结转主营业务收入', explanation: '主营业务收入转出，余额归零。本月累计收入304,600元转入本年利润。' },
      { subjectCode: '6401', debit: 0, credit: 185440, summary: '结转主营业务成本', explanation: '主营业务成本转出185,440元，余额归零。含促销成本、买赠成本、套装成本、福利成本和常规销售成本。' },
      { subjectCode: '6403', debit: 0, credit: 2826.2, summary: '结转税金及附加', explanation: '税金及附加转出2,826.20元，余额归零。含城建税1,978.34元和教育费附加847.86元。' },
      { subjectCode: '6601', debit: 0, credit: 29904, summary: '结转销售费用', explanation: '销售费用转出42,904元，余额归零。含返利4,000+福利904+广告费10,000+运杂费3,000+工资25,000。' },
      { subjectCode: '660101', debit: 0, credit: 18000, summary: '结转660101', explanation: '660101转出，余额归零。' },
      { subjectCode: '660102', debit: 0, credit: 3000, summary: '结转660102', explanation: '660102转出，余额归零。' },
      { subjectCode: '6602', debit: 0, credit: 4305, summary: '结转管理费用', explanation: '管理费用转出39,305元，余额归零。含福利2,825+工资35,000+折旧1,480。' },
      { subjectCode: '660201', debit: 0, credit: 1800, summary: '结转660201', explanation: '660201转出，余额归零。' },
      { subjectCode: '660203', debit: 0, credit: 35000, summary: '结转660203', explanation: '660203转出，余额归零。' },
      { subjectCode: '6603', debit: 0, credit: 1225, summary: '结转财务费用', explanation: '财务费用转出1,200元，余额归零。系乙公司现金折扣1,200元。' },
      { subjectCode: '4103', debit: 0, credit: 51695.80, summary: '费用转入本年利润', explanation: '本年利润减少记借方。将本月全部费用271,675.20元转入本年利润借方：主营业务成本185,440+销售费用42,904+管理费用39,305+财务费用1,200+税金及附加2,826.20。本月净利润=304,600-271,675.20=32,924.80元。' }
    ],
    documents: [
