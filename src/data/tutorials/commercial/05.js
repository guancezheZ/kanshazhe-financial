      ...
      ]signature: '仓库验收专用章' }]},
  {
    ...
    documents: [{ type: 'text', label: '买一赠一汇总表', docTitle: '买一赠一促销活动汇总表', stampText: '财务专用章',
      ...
      rows: [
        ...
        [
          '主商品',
          '48/(48+28)=63.16% → 15,157.89元'
        ],
        [
          '赠品',
          '28/(48+28)=36.84% → 8,842.11元'
        ],
        [
          '合计不含税收入',
          '24,000/1.13=21,238.94元'
        ],
        [
          '增值税',
          '2,761.06元'
    ...
    documents: [
      { type: 'text', label: '联营结算单', docTitle: '联营专柜结算单（2026年4月）', stampText: '联营结算专用章',
        ...
        rows: [
          ...
          [
            '应付供应商净额',
            '59,280.00元（76,000×78%）'
          ],
          [
            '制表',
            '李会计  审核：赵会计主管  联营商确认：美肌堂'
          ],
        ],
