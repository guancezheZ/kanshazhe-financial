...
const tasks = [
      ...
      { type: 'text', label: '增值税纳税申报表', docTitle: '增值税纳税申报表（简表）', content: '所属期：2026年7月\n销项税额：28,600元\n进项税额：15,600元\n应交增值税：13,000元\n已缴纳：13,000元\n申报日期：2026年7月29日' }]},
  {
    ...
    entries: [
      { subjectCode: '6001', debit: 220000, credit: 0, summary: '结转主营业务收入', explanation: '主营业务收入结转至本年利润。收入类科目期末余额转出，余额归零。本月收入合计=现销120,000+赊销100,000=220,000元。' },
      { subjectCode: '6401', debit: 0, credit: 132000, summary: '结转主营业务成本', explanation: '主营业务成本转出，余额归零。已销商品成本132,000元（C类72,000+A类60,000）。' },
      { subjectCode: '6403', debit: 0, credit: 1300, summary: '结转税金及附加', explanation: '税金及附加转出1,300元（计提的城建税910+教育费附加390）。' },
      { subjectCode: '6601', debit: 0, credit: 23500, summary: '结转销售费用', explanation: '销售费用转出31,500元（含差旅费3,500+广告费8,000+工资20,000）。' },
      { subjectCode: '660101', debit: 0, credit: 8000, summary: '结转660101', explanation: '660101转出，余额归零。' },
      { subjectCode: '660102', debit: 0, credit: 2500, summary: '结转660102', explanation: '660102转出，余额归零。' },
      { subjectCode: '6602', debit: 0, credit: 18840, summary: '结转管理费用', explanation: '管理费用转出48,340元（含房租6,000+水电2,500+通讯1,500+低值易耗品摊销6,000+管理人员差旅费4,500+管理人员工资25,000+折旧2,840）。' },
      { subjectCode: '660201', debit: 0, credit: 7500, summary: '结转660201', explanation: '660201转出，余额归零。' },
      { subjectCode: '660203', debit: 0, credit: 25000, summary: '结转660203', explanation: '660203转出，余额归零。' },
      { subjectCode: '6603', debit: 0, credit: 1872.5, summary: '结转财务费用', explanation: '财务费用转出1,812.50元（短期借款利息）。' },
      { subjectCode: '4103', debit: 512.5, credit: 0, summary: '结转各项费用支出', explanation: '本年利润减少记借方。将本期所有费用转入本年利润：主营业务成本132,000+税金及附加1,300+销售费用31,500+管理费用48,340+财务费用1,812.50=214,952.50元。本月净利润=220,000-214,952.50=5,047.50元。' }
    ],
    documents: [
