...
const tasks = [
  ...
  },
  {
    ...
    "entries": [
      { subjectCode: '221102', summary: '缴纳社保', debit: 34250, credit: 0, explanation: '应付职工薪酬-社保减少记借方。缴纳社保冲销负债。' },
      { subjectCode: '221102', summary: '缴纳社保', debit: 0, credit: 34250, explanation: '银行存款减少记贷方。缴纳社保支付。' },
    ],
    "documents": [
      {
        "type": "bank",
  ...
  },
  {
    ...
    "entries": [
      { subjectCode: '222102', summary: '缴纳所得税', debit: 140096.25, credit: 0, explanation: '应交所得税减少记借方。缴纳所得税冲销负债。' },
      { subjectCode: '222102', summary: '缴纳所得税', debit: 0, credit: 140096.25, explanation: '银行存款减少记贷方。缴纳所得税款支付。' },
    ],
    "documents": [
      {
        "type": "bank",
  ...
  },
  {
    ...
    "entries": [
      { subjectCode: '520101', summary: '计提项目工资', debit: 35000, credit: 0, explanation: '合同履约成本-人工增加记借方。项目人员工资计入成本。' },
      { subjectCode: '221101', summary: '应付职工薪酬', debit: 0, credit: 35000, explanation: '应付职工薪酬增加记贷方。计提工资负债增加。' },
    ],
    "documents": [
      {
        "type": "text",
  ...
  },
  {
    ...
    "entries": [
      { subjectCode: '660203', summary: '管理工资', debit: 22500, credit: 0, explanation: '管理费用-工资薪金增加记借方。管理人员工资计入管理费。' },
      { subjectCode: '221101', summary: '应付职工薪酬', debit: 0, credit: 22500, explanation: '应付职工薪酬增加记贷方。计提工资负债增加。' },
    ],
    "documents": [
      {
        "type": "text",
  ...
  },
  {
    ...
    "entries": [
      { subjectCode: '6401', summary: '结转App项目成本', debit: 99500, credit: 0, explanation: '主营业务成本增加记借方。项目完工结转成本。' },
      { subjectCode: '520101', summary: '结转人工', debit: 0, credit: 17500, explanation: '合同履约成本减少记贷方。完工结转人工成本。' },
      { subjectCode: '520103', summary: '结转外包费', debit: 0, credit: 80000, explanation: '合同履约成本减少记贷方。完工结转外包成本。' },
      { subjectCode: '520104', summary: '结转其他费用', debit: 0, credit: 2000, explanation: '合同履约成本减少记贷方。完工结转其他成本。' },
    ],
    "documents": [
      {
        "type": "text",
  ...
  },
  {
    ...
    "entries": [
      { subjectCode: '520101', summary: '项目下半月工资', debit: 35000, credit: 0, explanation: '合同履约成本-人工增加记借方。项目人员下半月工资计提。' },
      { subjectCode: '221101', summary: '应付职工薪酬', debit: 0, credit: 35000, explanation: '应付职工薪酬增加记贷方。计提工资负债增加。' },
    ],
    "documents": [
      {
  ...
  },
  {
    ...
    "entries": [
      { subjectCode: '660205', summary: '计提折旧', debit: 4085, credit: 0, explanation: '管理费用-折旧费增加记借方。折旧费用计入管理费用。' },
  ...
  },
  {
    ...
    "entries": [
      { subjectCode: '660206', summary: '无形资产摊销', debit: 2555.55, credit: 0, explanation: '管理费用-摊销费增加记借方。摊销无形资产费用。' },
  ...
  },
  {
    ...
    "entries": [
      { subjectCode: '222103', summary: '城建税', debit: 504, credit: 0, explanation: '应交城建税增加记借方。计提城建税。' },
      { subjectCode: '222104', summary: '教育费附加', debit: 216, credit: 0, explanation: '应交教育费附加增加记借方。计提教育费附加。' },
        { subjectCode: '222103', summary: '城建税', debit: 0, credit: 504, explanation: '应交城建税增加记贷方。按增值税计提城建税。' },
      { subjectCode: '222104', summary: '教育费附加', debit: 0, credit: 216, explanation: '应交教育费附加增加记贷方。按增值税计提教育费附加。' },
    ],
    "documents": [
      {
        "type": "text",
  ...
  },
  {
    ...
    "entries": [
      ...
      { subjectCode: '4103', summary: '收入转本年利润', debit: 0, credit: 200000, explanation: '本年利润增加记贷方。结转收入增加本年利润。' },
      { subjectCode: '4103', summary: '成本费用转入', debit: 242110.55, credit: 0, explanation: '本年利润减少记借方。费用结转至本年利润。' },
      { subjectCode: '6401', summary: '结转成本', debit: 0, credit: 99500, explanation: '主营业务成本减少记贷方。期末结转至本年利润。' },
      { subjectCode: '6403', summary: '结转税金', debit: 0, credit: 720, explanation: '税金及附加减少记贷方。期末结转至本年利润。' },
      { subjectCode: '660201', summary: '结转管理费用', debit: 0, credit: 142390.55, explanation: '管理费用减少记贷方。期末结转至本年利润。' },
      { subjectCode: '6603', summary: '结转财务费用', debit: 500, credit: 0, explanation: '财务费用减少记借方。利息收入冲减财务费用。' },
      ],
    },
  {
    "date": "2026-04-01",
  ...
  },
  {
    ...
    "role": "cashier",
    "entries": [
      { subjectCode: '221101', summary: '发工资', debit: 137000, credit: 0, explanation: '应付职工薪酬减少记借方。发放工资冲销负债。' },
      { subjectCode: '221101', summary: '发工资', debit: 0, credit: 132890, explanation: '银行存款减少记贷方。发放工资转账支付。' },
      { subjectCode: '222102', summary: '扣个税', debit: 0, credit: 4110, explanation: '应交个人所得税增加记贷方。代扣个人所得税。' },
    ],
    "documents": [
      {
        "type": "bank",
  ...
  },
  {
    ...
    "role": "cashier",
    "entries": [
      { subjectCode: '100201', summary: '定金到账', debit: 106000, credit: 0, explanation: '银行存款增加记借方。客户定金到账。' },
      { subjectCode: '100201', summary: '定金', debit: 0, credit: 106000, explanation: '合同负债增加记贷方。收到定金形成合同负债。' },
    ],
    "documents": [
      {
        "type": "bank",
  ...
  },
  {
    ...
    "role": "cashier",
    "entries": [
      { subjectCode: '520103', summary: '外包费', debit: 80000, credit: 0, explanation: '合同履约成本-外包费增加记借方。外包服务归集成本。' },
      { subjectCode: '520103', summary: '外包费', debit: 0, credit: 80000, explanation: '合同履约成本-外包费减少记贷方。完工结转外包成本。' },
    ],
    "documents": [
      {
        "type": "bank",
  ...
  },
  {
    ...
    "role": "cashier",
    "entries": [
        { subjectCode: '6603', summary: '利息收入', debit: 500, credit: 0, explanation: '财务费用减少记贷方。利息收入冲减财务费用。' },
      { subjectCode: '6603', summary: '利息收入', debit: 0, credit: 500, explanation: '财务费用减少记贷方。银行存款增加记贷方。利息收入冲减财务费用。' },
    ],
    "documents": [
      {
  ...
  },
  {
    ...
    "role": "cashier",
    "entries": [
      { subjectCode: '100202', summary: '转入建行', debit: 50000, credit: 0, explanation: '银行存款增加记借方。资金转入建设银行账户。' },
      { subjectCode: '100201', summary: '工行转出', debit: 0, credit: 50000, explanation: '银行存款减少记贷方。通过工商银行转账支付。' },
    ],
    "documents": [
      {
        "type": "bank",
