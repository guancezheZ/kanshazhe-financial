...
const tasks = [
  ...
  },
  {
    ...
    "entries": [
      ...
      { subjectCode: '100201', summary: '实发', debit: 0, credit: 121250, explanation: '银行存款减少记贷方。实发工资转账支付。' },
  ...
  },
  {
    ...
    "entries": [
      { subjectCode: '100201', summary: '预收运维费', debit: 95400, credit: 0, explanation: '银行存款增加记借方。预收运维服务费。' },
  ...
  },
  {
    ...
    "role": "cashier",
    "entries": [
      { subjectCode: '100201', summary: '预收', debit: 95400, credit: 0, explanation: '银行存款增加记借方。预收客户款项。' },
  ...
  },
  {
    ...
    "entries": [
      ...
      { subjectCode: '101204', summary: '微信付款', debit: 0, credit: 5000, explanation: '其他货币资金-微信减少记贷方。微信支付款项。' },
    ],
    "documents": [
      {
        "type": "text",
  ...
  },
  {
    ...
    "entries": [
      ...
      { subjectCode: '100201', summary: '银行存款减少', debit: 0, credit: 600, explanation: '银行存款减少记贷方。银行款项支出。' },
    ],
    "documents": [
      {
        "type": "text",
  ...
  },
  {
    ...
    "entries": [
      ...
      { subjectCode: '1001', summary: '现金减少', debit: 0, credit: 8000, explanation: '库存现金减少记贷方。现金支付款项。' },
    ],
    "documents": [
      {
        "type": "text",
  ...
  },
  {
    ...
    "role": "cashier",
    "entries": [
      { subjectCode: '100201', summary: '银行存款增加', debit: 100000, credit: 0, explanation: '银行存款增加记借方。款项存入银行。' },
