  ...
  { date: '2026-11-03', role: 'accountant', title: '发放10月员工工资', tags: ["工资社保"], difficulty: 1,
    ...
    documents: [
      ...
      rows: [
        ...
        [
          '扣款',
          '社保26,000+公积金13,000+个税6,000=45,000元'
        ],
        [
          '实发合计',
          '215,000.00元（银行代发）'
  ...
  { date: '2026-11-27', role: 'accountant', title: '月末期间损益结转', tags: ["期末"], difficulty: 3,
    ...
    documents: [
      ...
      rows: [
        ...
        [
          '主营业务收入',
          '305,000元（E20,000+G15,000+I120,000+J150,000）'
        ],
        [
          '其他业务收入',
          '15,000元（H订阅）'
