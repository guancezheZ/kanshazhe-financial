/**
 * 服务业（管理咨询/软件开发）教学任务入口
 *
 * 行业特点：无存货、无生产核算、人工成本为主、项目制核算
 * 企业类型：一般纳税人（增值税6%）
 * 会计准则依据：《企业会计准则第14号——收入》（财会[2017]22号）
 *
 * 知识点标签（10类）：
 * 项目核算、收入确认、人工成本、费用管理、工资社保、税费、往来管理、资金管理、期末、出纳
 */
...
export function getServiceTutorials(month) {
  return MONTHS[month] || []
}

export function getServiceAllMonths() {
  return Object.keys(MONTHS)
}

export function getServiceMonthLabels() {
