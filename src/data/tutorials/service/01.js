...
const tasks = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    entries: [
      { subjectCode: '100201', summary: '收到追加投资款', debit: 500000, credit: 0, explanation: '银行存款增加记借方。资金已存入工商银行账户，资产增加。' },
  ...
  },
  {
    ...
    entries: [
      { subjectCode: '100201', summary: '取得短期借款', debit: 300000, credit: 0, explanation: '银行存款增加记借方。借款资金到账，企业可动用资金增加。' },
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '购买办公设备', debit: 0, credit: 48000, explanation: '银行存款减少记贷方。通过银行转账支付设备款项，资产减少。' },
    ],
    documents: [
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '预付半年房租', debit: 0, credit: 120000, explanation: '银行存款减少记贷方。通过银行转账支付租金，资产减少。' },
    ],
    documents: [
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '1001', summary: '购买办公用品', debit: 0, credit: 1500, explanation: '库存现金减少记贷方。现金支付办公用品款项，资产减少。' },
    ],
    documents: [
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '银行账户管理费', debit: 0, credit: 200, explanation: '银行存款减少记贷方。银行自动扣划费用，资产减少。' },
    ],
    documents: [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    entries: [
      { subjectCode: '100201', summary: '收取咨询合同定金', debit: 106000, credit: 0, explanation: '银行存款增加记借方。收到客户预付的合同定金（100,000+增值税6,000）。' },
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '1001', summary: '预借差旅费', debit: 0, credit: 9000, explanation: '库存现金减少记贷方。现金支付给员工作为差旅备用金。' },
    ],
    documents: [
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '支付开发工具授权费', debit: 0, credit: 30000, explanation: '银行存款减少记贷方。通过银行转账支付授权费用。' },
    ],
    documents: [
  ...
  },
  {
    ...
    entries: [
      { subjectCode: '100201', summary: '收取软件开发启动资金', debit: 127200, credit: 0, explanation: '银行存款增加记借方。收到客户预付的启动资金（400,000×30%=120,000，增值税7,200）。' },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    entries: [
      ...
      { subjectCode: '1001', summary: '退回多余差旅费借款', debit: 500, credit: 0, explanation: '库存现金增加记借方。员工退回多余的预借差旅费。' },
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '支付办公室水电费', debit: 0, credit: 5600, explanation: '银行存款减少记贷方。通过银行支付水电费用。' },
    ],
    documents: [
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '1001', summary: '支付业务招待费', debit: 0, credit: 2000, explanation: '库存现金减少记贷方。现金支付招待费用。' },
    ],
    documents: [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    entries: [
      { subjectCode: '100201', summary: '收到咨询项目尾款', debit: 106000, credit: 0, explanation: '银行存款增加记借方。客户支付项目尾款，资金到账。' },
  ...
  },
  {
    ...
    entries: [
      { subjectCode: '100201', summary: '登记投资款到账', debit: 500000, credit: 0, explanation: '银行存款日记账登记收入方。' },
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '支付办公设备款', debit: 0, credit: 48000, explanation: '银行存款减少记贷方。' },
    ],
    documents: [
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '预付半年房租', debit: 0, credit: 120000, explanation: '银行存款减少记贷方。' },
    ],
    documents: [
      { type: 'bank', label: '付款回单', date: '2026-01-05', totalAmount: 120000, payer: '雲帆管理咨询有限公司', payeeName: '北京鼎盛物业管理有限公司', content: '办公室租金', refNo: 'FK202601050001' },
    ],
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '银行账户管理费', debit: 0, credit: 200, explanation: '银行存款减少记贷方。' },
    ],
    documents: [
      { type: 'receipt', label: '银行扣费通知', docTitle: '业务收费回单', items: [{ name: '账户管理费', amount: 200 }], totalAmount: 200, stampText: '中国工商银行 业务专用章' },
    ],
  },
  {
    ...
    entries: [
      { subjectCode: '100201', summary: '咨询合同定金到账', debit: 106000, credit: 0, explanation: '银行存款增加记借方。' },
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '1001', summary: '支付差旅费预借款', debit: 0, credit: 9000, explanation: '库存现金减少记贷方。' },
    ],
    documents: [
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '支付开发工具授权费', debit: 0, credit: 30000, explanation: '银行存款减少记贷方。' },
    ],
    documents: [
  ...
  },
  {
    ...
    entries: [
      { subjectCode: '100201', summary: '开发启动资金到账', debit: 127200, credit: 0, explanation: '银行存款增加记借方。' },
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '1001', summary: '退回多余借款', debit: 500, credit: 0, explanation: '库存现金增加记借方。' },
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '支付水电费', debit: 0, credit: 5600, explanation: '银行存款减少记贷方。' },
    ],
    documents: [
  ...
  },
  {
    ...
    entries: [
      { subjectCode: '100201', summary: '咨询项目尾款到账', debit: 106000, credit: 0, explanation: '银行存款增加记借方。' },
