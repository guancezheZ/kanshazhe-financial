...
const tasks = [
    ...
    "entries": [
      {
        ...
        "debit": 127200,
        "credit": 0,
        "explanation": "银行存款增加记借方。收到项目启动资金。",
        "cashFlowItem": "cf-op5",
  ...
  },
  {
    ...
    "difficulty": 3,
    "entries": [
      { subjectCode: '6001', debit: 240000, credit: 0, summary: '收入', explanation: '主营业务收入减少记借方。期末结转至本年利润。' },
      { subjectCode: '6602', debit: 0, credit: 8000, summary: '结转6602', explanation: '6602转出，余额归零。' },
      { subjectCode: '660201', debit: 0, credit: 11300, summary: '管理费用', explanation: '管理费用减少记贷方。期末结转至本年利润。' },
      { subjectCode: '660202', debit: 0, credit: 14400, summary: '结转660202', explanation: '660202转出，余额归零。' },
      ...
      { subjectCode: '4103', debit: 0, credit: 32542.78, summary: '收入转利润', explanation: '本年利润增加记贷方。收入结转至本年利润。' }
    ],
    "documents": [
      {
        "type": "text",
