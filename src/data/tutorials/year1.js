...
const tutorials = {
  '01': [
    ...
    { date: '2026-01-23', role: 'accountant', title: '购买办公电脑', tags: ["资产"], difficulty: 1, tip: '购买办公电脑，原值4,500元。', description: '公司购入联想台式电脑一台，原值4,500元，预计使用36个月，无残值，款项通过工商银行支付。', entries: [{ subjectCode: '160103', summary: '购买办公电脑', debit: 4500, credit: 0, explanation: '固定资产-办公设备增加。购入联想台式电脑，按购入成本入账。' }, { subjectCode: '100201', summary: '支付电脑款', debit: 0, credit: 4500, explanation: '银行存款减少。支付电脑采购款，次月开始计提折旧。' }], documents: [{ type: 'text', label: '增值税发票', docTitle: '增 值 税 发 票', date: '2026-01-23', stampText: '发票专用章', content: '发票代码：110024****\n开票日期：2026年01月23日\n\n购买方：本公司\n纳税人识别号：91440101MA5XXXXXX\n\n销售方：XX电脑销售公司\n\n商品信息：\n  联想台式电脑 ThinkCentre M730e × 1台\n  单价：4,500.00元\n  金额：4,500.00元\n  税率：13%\n  税额：517.70元\n\n价税合计：肆仟伍佰元整\n（小写）¥4,500.00' }, { type: 'bank', label: '付款回单', date: '2026-01-23', totalAmount: 4500, payer: '本公司', payerAccount: '6222 0200 **** 1234', payeeName: 'XX电脑销售公司', content: '购买联想台式电脑', refNo: 'HD202601230050' }]},
    { date: '2026-01-24', role: 'accountant', title: '计提工资', tags: ["工资"], difficulty: 1, tip: '按部门计提1月工资。', description: '计提1月工资：行政部25,000元、销售部35,000元、生产部30,000元，合计90,000元。', entries: [{ subjectCode: '660203', summary: '计提行政部工资', debit: 25000, credit: 0, explanation: '管理费用-工资增加。行政部员工工资计入管理费用。' }, { subjectCode: '6601', summary: '计提销售部工资', debit: 35000, credit: 0, explanation: '销售费用增加。销售部员工工资计入销售费用。' }, { subjectCode: '500102', summary: '计提生产部工资', debit: 30000, credit: 0, explanation: '生产成本-直接人工增加。生产部员工工资计入生产成本。' }, { subjectCode: '221101', summary: '计提本月工资', debit: 0, credit: 90000, explanation: '应付职工薪酬-工资增加。计提形成对员工的负债，实际发放时冲减。' }], documents: [{ type: 'text', label: '工资计算表', docTitle: '1 月 工 资 计 算 表', date: '2026-01-24', stampText: '财务专用章', content: '期间：2026年1月\n\n一、行政部（2人）\n  张管理：15,000元\n  李行政：10,000元\n  小计：25,000元\n\n二、销售部（2人）\n  王销售：20,000元\n  赵销售：15,000元\n  小计：35,000元\n\n三、生产部（2人）\n  刘生产：18,000元\n  陈生产：12,000元\n  小计：30,000元\n\n应发合计：90,000元\n\n制表：李会计\n审核：赵会计主管' }]},
    ...
    { date: '2026-01-26', role: 'accountant', title: '计提折旧', tags: ["资产"], difficulty: 1, tip: '当月新增固定资产次月开始计提折旧。', description: '本月无折旧计提——联想台式电脑于1月23日购入，按会计准则规定，当月增加固定资产当月不计提折旧，从次月起计提。月折旧额=4,500÷36=125元，自2月起每月计提。', entries: [], documents: [{ type: 'text', label: '折旧政策说明', docTitle: '固 定 资 产 折 旧 说 明', date: '2026-01-26', stampText: '财务专用章', content: '折旧方法：年限平均法（直线法）\n残值率：0%\n使用年限：3年（36个月）\n\n新增资产：联想台式电脑\n原值：4,500.00元\n购入日期：2026-01-23\n\n月折旧额 = 4,500 ÷ 36 = 125.00元\n\n开始计提：2026年2月\n首次折旧分录：\n  借：管理费用-折旧费（660205）125\n  贷：累计折旧（1602）125\n\n依据：《企业会计准则第4号——固定资产》\n第十四条：当月增加固定资产，当月不计提折旧，从下月起计提。' }]},
