const jul = [
  ...
  { date: '2026-07-25', role: 'accountant', title: '支付水电费', tags: ["费用"], difficulty: 1, tip: '水电费入管理费。',
    ...
    entries: [{ subjectCode: '6602', summary: '水电费', debit: 4500, credit: 0, explanation: '管理费增加。' }, { subjectCode: '100201', summary: '付款', debit: 0, credit: 4500, explanation: '银行减少。' }],
  ...
  { date: '2026-07-30', role: 'accountant', title: '盘亏处理（查明原因）', tags: ["生产","资产"], difficulty: 2, tip: '管理不善计入管理费用。',
    ...
    entries: [{ subjectCode: '6602', summary: '盘亏损失', debit: 5000, credit: 0, explanation: '管理费增加。' }, { subjectCode: '190101', summary: '转出', debit: 0, credit: 5000, explanation: '待处理损溢减少。' }],
