...
所得税计算：
...

  {
    ...
    entries: 
[
      { subjectCode: '6001', debit: 160000, credit: 0, summary: '结转主营业务收入', explanation: '主营业务收入结转至本年利润。' },
      { subjectCode: '6051', debit: 8000, credit: 0, summary: '结转其他业务收入', explanation: '其他业务收入结转至本年利润。' },
      { subjectCode: '6111', debit: 12000, credit: 0, summary: '结转投资收益', explanation: '投资收益结转至本年利润。' },
      { subjectCode: '6701', debit: 1500, credit: 0, summary: '结转资产减值损失', explanation: '资产减值损失结转至本年利润。' },
      { subjectCode: '6401', debit: 0, credit: 80000, summary: '结转主营业务成本', explanation: '主营业务成本结转至本年利润，余额归零。' },
      { subjectCode: '6402', debit: 0, credit: 2375, summary: '结转其他业务成本', explanation: '其他业务成本结转至本年利润。' },
      { subjectCode: '6403', debit: 0, credit: 1560, summary: '结转税金及附加', explanation: '税金及附加结转至本年利润，余额归零。' },
      { subjectCode: '6601', debit: 0, credit: 44500, summary: '结转销售费用', explanation: '销售费用结转至本年利润，余额归零。' },
      { subjectCode: '660101', debit: 0, credit: 8000, summary: '结转销售费用-广告费', explanation: '广告费结转至本年利润，余额归零。' },
      { subjectCode: '6602', debit: 0, credit: 18500, summary: '结转管理费用', explanation: '管理费用结转至本年利润，余额归零。' },
      { subjectCode: '660201', debit: 0, credit: 500, summary: '结转管理费用-办公费', explanation: '办公费结转至本年利润，余额归零。' },
      { subjectCode: '660203', debit: 0, credit: 31000, summary: '结转管理费用-工资', explanation: '管理工资结转至本年利润，余额归零。' },
      { subjectCode: '6603', debit: 0, credit: 295, summary: '结转财务费用', explanation: '财务费用结转至本年利润，余额归零。' },
      { subjectCode: '6801', debit: 0, credit: 26864, summary: '结转所得税费用', explanation: '所得税费用结转至本年利润。' },
      { subjectCode: '5101', debit: 0, credit: 5000, summary: '结转制造费用', explanation: '制造费用结转至生产成本，余额归零。' },
      { subjectCode: '4103', summary: '结转本年利润', debit: 37094, credit: 0, explanation: '本年利润结转至利润分配。' },
    ]
,
