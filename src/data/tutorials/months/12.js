...
const dec = [
...

  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '缴纳税款', debit: 0, credit: 11700, explanation: '银行存款减少11,700元。' },
    ],
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '缴纳税款', debit: 0, credit: 1170, explanation: '银行存款减少1,170元。' },
    ],
...

  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '支付款项', debit: 0, credit: 500, explanation: '银行存款减少500元。' },
    ],
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '报销差旅费', debit: 0, credit: 2500, explanation: '银行存款减少2,500元。' },
    ],
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '手续费', debit: 0, credit: 150, explanation: '银行存款减少150元。' },
    ],
...

  {
    ...
    tip: '请根据业务场景理解并完成本业务的分录录入。',
    entries: [
      { subjectCode: '100201', summary: '销售A产品', debit: 180800, credit: 0, explanation: '银行存款增加180,800元。' },
  ...
  },
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '支付材料款', debit: 0, credit: 45200, explanation: '银行存款减少45,200元。' },
    ],
...
或点击下方"🧾 去报税"按钮` }],
     ...
     ═══════════════════════════════════════════════ */
  {
    ...
    entries: [
      ...
      { subjectCode: '100201', summary: '支付采购尾款', debit: 0, credit: 35000, explanation: '银行存款减少记贷方。年终结算尾款通过工商银行转账支付。' },
    ],
    documents: [
...
对账单已发函确认，回函率100%。` },
  ...
  { date: '2026-12-31',
    ...
    difficulty: 1,
    role: 'cashier',
    description: '年末最后一天，全年最后一次银行对账。核对全年银行存款日记账与银行对账单是否一致。本年业务量大，需逐笔勾对。',
    tip: '年末收官——全年最后一次银行对账！2026年即将结束，需确保全年银行账目准确无误。',
    entries: [],
    documents: [{ type: 'text', label: '银行对账单', docTitle: '银行对账单', stampText: '工行电子章',
      content: `12月期初371,470.09 期末381,650.09` }] },
  { date: '2026-12-01', title: '月初现金清点', tags: ["出纳"], difficulty: 1, role: 'cashier',
  ...
  { date: '2026-12-02', title: '提取备用金', tags: ["出纳"], difficulty: 1, role: 'cashier',
  ...
  { date: '2026-12-05', title: '银行代扣社保', tags: ["出纳","工资社保"], difficulty: 2, role: 'cashier',
  ...
  { date: '2026-12-06', title: '网络费', tags: ["出纳","费用"], difficulty: 1, role: 'cashier',
  ...
  { date: '2026-12-09', title: '银行代扣公积金', tags: ["出纳","工资社保"], difficulty: 2, role: 'cashier',
  ...
  { date: '2026-12-10', title: '年度现金盘点 ⭐', tags: ["出纳"], difficulty: 2, role: 'cashier',
    description: '年终全面盘点库存现金。账实相符。', tip: '年度现金盘点需三方签字。', entries: [], documents: [
      { type: 'text', label: '现金盘点表', docTitle: '2026年度现金盘点表', stampText: '财务专用章',
        content: `账面：4,200.00\n实盘：4,200.00\n结果：相符✓` }] },
  { date: '2026-12-12', title: '快递费', tags: ["出纳","费用"], difficulty: 1, role: 'cashier',
  ...
  { date: '2026-12-16', title: '购买支票本', tags: ["出纳"], difficulty: 1, role: 'cashier',
  ...
  { date: '2026-12-18', title: '年度票据清查 ⭐', tags: ["出纳"], difficulty: 2, role: 'cashier',
    description: '年终全面清查各类票据。全部账实相符。', tip: '年度票据清查。', entries: [], documents: [
      { type: 'text', label: '票据清查表', docTitle: '2026年度票据清查表', stampText: '财务专用章',
        content: `应收票据：0张\n应付票据：0张\n结果：全部相符✓` }] },
  { date: '2026-12-23', title: '账户管理费', tags: ["出纳","费用"], difficulty: 1, role: 'cashier',
  ...
  { date: '2026-12-25', title: '银行手续费', tags: ["出纳","费用"], difficulty: 1, role: 'cashier',
    description: '12月手续费150元。', tip: '核对金额。',
    entries: [{ subjectCode: '6603', summary: '手续费', debit: 150, credit: 0, explanation: '费用增加。' }, { subjectCode: '100201', summary: '手续费', debit: 0, credit: 150, explanation: '银行减少。' }],
    documents: [{ type: 'bank', label: '回单', date: '2026-12-25', totalAmount: 150, payer: '本公司', payeeName: '工行', content: '12月手续费', refNo: 'HD202612250025' }] },
  { date: '2026-12-26', title: '清洁费', tags: ["出纳","费用"], difficulty: 1, role: 'cashier',
  ...
  { date: '2026-12-27', title: '印刷费', tags: ["出纳","费用"], difficulty: 1, role: 'cashier',
    description: '支付12月印刷费800元。', tip: '核对验收单。',
    entries: [{ subjectCode: '6602', summary: '印刷费', debit: 800, credit: 0, explanation: '管理费增加。' }, { subjectCode: '100201', summary: '印刷费', debit: 0, credit: 800, explanation: '银行减少。' }],
  ...
  { date: '2026-12-28', title: '年度回单归档', tags: ["出纳"], difficulty: 1, role: 'cashier',
    description: '年终整理全年银行回单。', tip: '年度档案归档。', entries: [], documents: [
      { type: 'text', label: '归档清册', docTitle: '2026年度归档清册', stampText: '财务专用章',
        content: `全年约230笔\n归档人：王出纳` }] },
  { date: '2026-12-29', title: '银行年检', tags: ["出纳"], difficulty: 1, role: 'cashier',
