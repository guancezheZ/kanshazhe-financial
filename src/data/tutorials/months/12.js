const dec = [
  ...
  { date: '2026-12-24', role: 'accountant', title: '支付水电费', tags: ["费用"], difficulty: 1, tip: '水电费入管理费。',
    ...
    entries: [{ subjectCode: '6602', summary: '水电费', debit: 5000, credit: 0 , explanation: '管理费用增加。' }, { subjectCode: '100201', summary: '付款', debit: 0, credit: 5000 , explanation: '银行存款减少。' }],
  ...
  { date: '2026-12-25', role: 'accountant', title: '年末资产盘点', tags: ["资产","期末"], difficulty: 2, tip: '年末全面盘点。',
    ...
    entries: [{ subjectCode: '6602', summary: '盘点费用', debit: 2000, credit: 0 , explanation: '管理费用增加。' }, { subjectCode: '100201', summary: '付款', debit: 0, credit: 2000 , explanation: '银行存款减少。' }],
