...
合计代扣：9,750.00` }]},
  {
    ...
    tags: ["期末"],
      difficulty: 3,
    description: '月末将各损益类科目余额结转至"本年利润"。本月收入 223,097.35元，各项费用合计约 95,658.15元。',
    tip: '本月收入大幅增长，首次实现月度盈利！注意结转后各损益类科目余额应为零。收入类从借方转出，费用类从贷方转出。',
    entries: [
      { subjectCode: '6001', summary: '结转主营业务收入', debit: 223097.35, credit: 0,
        explanation: '为什么结转入本年利润时借记"主营业务收入"？收入类科目平时在贷方，月末余额在贷方。结转时从借方转出（借方发生额=贷方余额），余额归零。收入223,097.35元转入本年利润贷方，增加了所有者权益。' },
      { subjectCode: '6603', summary: '结转财务费用（利息净收入冲减后）', debit: 256.25, credit: 0, explanation: '财务费用利息净收入256.25元（利息收入3,200元减利息支出543.75元和现金折扣2,400元），净额结转至本年利润，增加利润。' },
      { subjectCode: '660201', summary: '结转管理费用-办公费', debit: 0, credit: 1760, explanation: '办公费转出记贷方。月末余额归零。本月办公费合计1,760元（560+1,200）。' },
      { subjectCode: '660202', summary: '结转管理费用-差旅费', debit: 0, credit: 2800, explanation: '差旅费转出记贷方。月末余额归零。' },
      { subjectCode: '6602', summary: '结转管理费用（折旧/摊销/水电/维修）', debit: 0, credit: 19160, explanation: '管理费用转出记贷方。月末结转至本年利润，余额归零。本月管理费合计19,160元（水电3,900+维修3,500+法律顾问5,000+折旧2,000+摊销2,000+印刷1,800+报刊960）。' },
      ...
      { subjectCode: '4103', summary: '结转本月净利润', debit: 0, credit: 127439.2, explanation: '本年利润是所有者权益科目。贷方余额表示盈利，年末结转至"利润分配-未分配利润"。本月净利润=收入223,097.35-费用95,658.15=127,439.20元。' }],
    documents: [
