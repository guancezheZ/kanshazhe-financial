const feb = [
  ...
  { date: '2026-02-27', role: 'accountant', title: '计提工资及折旧', tags: ["工资","资产"], difficulty: 1, tip: '通过业务模块操作。',
    description: '前往工资管理模块计提2月工资90,000元，然后前往固定资产模块计提本月折旧。',
    entries: [], nextAction: 'payroll',
    documents: [{ type: 'text', label: '操作指引', docTitle: '月 末 计 提 操 作 说 明', date: '2026-02-27', stampText: '财务专用章', content: '请按顺序完成以下操作：\n\n【第一步】计提工资\n1. 前往「工资管理」模块\n2. 点击「计算汇总」查看应发合计\n3. 点击「生成计提工资凭证」\n4. 系统自动过账\n\n【第二步】计提折旧\n1. 前往「固定资产」模块\n2. 点击「计提本月折旧」\n3. 确认折旧金额后系统自动生成凭证\n\n应发工资合计：90,000元\n  行政部：25,000\n  销售部：35,000\n  生产部：30,000' }]},
  { date: '2026-02-28', role: 'accountant', title: '计提折旧', tags: ["资产"], difficulty: 1, tip: '通过固定资产模块。',
    description: '前往固定资产模块点击"计提本月折旧"，系统将自动计算并生成折旧凭证。',
    entries: [], nextAction: 'fixed-assets',
    documents: [{ type: 'text', label: '操作指引', docTitle: '计 提 折 旧 操 作 说 明', date: '2026-02-28', stampText: '固定资产\n管理专用章', content: '操作步骤：\n1. 打开「固定资产」模块\n2. 点击「计提本月折旧」按钮\n3. 系统自动计算本月折旧额\n4. 确认无误后点击确定\n5. 系统自动生成折旧凭证并过账\n\n注意事项：\n- 当月新增固定资产次月开始计提\n- 折旧方法：平均年限法（直线法）\n- 残值率：5%' }]},
  ...
  { date: '2026-02-28', role: 'accountant', title: '月末期间损益结转', tags: ["期末"], difficulty: 3, tip: '收入借转，费用贷转。',
    ...
    entries: [
      ...
      { subjectCode: '6602', summary: '转管理费用', debit: 0, credit: 14200, explanation: '管理费转出。14,200元。' },
