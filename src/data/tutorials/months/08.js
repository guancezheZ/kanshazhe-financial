...
合计：3,705.00` }]},
  {
    ...
    entries: 
[
      { subjectCode: '6001', debit: 495000, credit: 0, summary: '结转主营业务收入', explanation: '主营业务收入结转至本年利润。' },
      { subjectCode: '6051', debit: 10000, credit: 0, summary: '结转其他业务收入', explanation: '其他业务收入结转至本年利润。' },
      { subjectCode: '6111', debit: 104.17, credit: 0, summary: '结转投资收益', explanation: '投资收益结转至本年利润。' },
      { subjectCode: '6403', debit: 0, credit: 3705, summary: '结转税金及附加', explanation: '税金及附加结转至本年利润，余额归零。' },
      { subjectCode: '6601', debit: 0, credit: 42000, summary: '结转销售费用', explanation: '销售费用结转至本年利润，余额归零。' },
      ...
      { subjectCode: '660202', debit: 0, credit: 3000, summary: '结转管理费用-差旅费', explanation: '差旅费结转至本年利润，余额归零。' },
      { subjectCode: '660203', debit: 0, credit: 31000, summary: '结转管理费用-工资', explanation: '管理工资结转至本年利润，余额归零。' },
      { subjectCode: '6603', debit: 0, credit: 1488.75, summary: '结转财务费用', explanation: '财务费用结转至本年利润，余额归零。' },
      { subjectCode: '6701', debit: 0, credit: 10650, summary: '结转资产减值损失', explanation: '资产减值损失结转至本年利润。' },
      { subjectCode: '5101', debit: 0, credit: 5000, summary: '结转制造费用', explanation: '制造费用结转至生产成本，余额归零。' },
      { subjectCode: '4103', summary: '结转本年利润', debit: 0, credit: 389060.42, explanation: '本年利润结转至利润分配。' },
    ]
,
    documents: [
    ...
    documents: [
      { type: 'invoice', label: '增值税发票', region: '广东', invoiceType: '专用', copy: '发票联', invoiceNo: '4400812345', date: '2026年08月28日', buyer: '乙公司', buyerTaxId: '91440101MA5XXXXXXXX', seller: '本公司', sellerTaxId: '91440101MA3XXXXXXXX', stampText: '国家税务总局\n发票专用章',
        lineItems: [
          ...
          { name: '安装服务', unit: '项', qty: 1, price: 10000, amount: 10000, taxRate: '9%', tax: 900 }], totalAmount: 101300 },
