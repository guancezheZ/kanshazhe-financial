const apr = [
  ...
  { date: '2026-04-15', role: 'accountant', title: '支付水电费', tags: ["费用"], difficulty: 1, tip: '水电费入管理费。',
    ...
    entries: [{ subjectCode: '6602', summary: '水电费', debit: 4700, credit: 0, explanation: '管理费增加。' }, { subjectCode: '100201', summary: '付款', debit: 0, credit: 4700, explanation: '银行减少。' }],
  ...
  { date: '2026-04-27', role: 'accountant', title: '计提工资及折旧', tags: ["工资","资产"], difficulty: 1, tip: '通过业务模块操作。',
    description: '前往工资管理模块计提4月工资90,000元，然后前往固定资产模块计提本月折旧。', entries: [], nextAction: 'payroll',
    documents: [{ type: 'text', label: '操作指引', docTitle: '月 末 计 提 操 作 说 明', stampText: '财务专用章', content: '请按顺序完成：\n\n【第一步】计提工资\n1. 工资管理→计算汇总\n2. 生成计提工资凭证\n\n【第二步】计提折旧\n1. 固定资产→计提本月折旧\n2. 确认后自动生成凭证' }]},
