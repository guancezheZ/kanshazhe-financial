const sep = [
  ...
  { date: '2026-09-26', role: 'accountant', title: '计提工资及折旧', tags: ["工资","资产"], difficulty: 1, tip: '计提9月工资及折旧。', description: '计提9月工资90,000元及固定资产折旧625元（不含投资性房地产折旧）。', entries: [{ subjectCode: '660203', summary: '计提行政部工资', debit: 25000, credit: 0, explanation: '管理费用-工资增加。' }, { subjectCode: '660103', summary: '计提销售部工资', debit: 35000, credit: 0, explanation: '销售费用增加。' }, { subjectCode: '500102', summary: '计提生产部工资', debit: 30000, credit: 0, explanation: '生产成本-直接人工增加。' }, { subjectCode: '221101', summary: '计提本月工资', debit: 0, credit: 90000, explanation: '应付职工薪酬-工资增加。' }, { subjectCode: '660205', summary: '计提固定资产折旧', debit: 625, credit: 0, explanation: '管理费用-折旧费增加。不含投资性房地产折旧。' }, { subjectCode: '1602', summary: '计提固定资产折旧', debit: 0, credit: 625, explanation: '累计折旧增加。' }], documents: [{ type: 'text', label: '9月计提表', docTitle: '9 月 计 提 计 算 表', date: '2026-09-26', stampText: '财务专用章', content: '一、工资计提\n  合计：90,000元\n\n二、固定资产折旧\n  电脑+车床：625元\n  注：投资性房地产折旧已在单独任务处理。\n\n制表：李会计  审核：赵会计主管' }]},
