const jun = [
  ...
  { date: '2026-06-15', role: 'accountant', title: '支付水电费', tags: ["费用"], difficulty: 1, tip: '水电费入管理费。', description: '支付6月水电费4,000元。',
    entries: [{ subjectCode: '660208', summary: '水电费', debit: 4000, credit: 0, explanation: '管理费增加。' }, { subjectCode: '100201', summary: '付水电费', debit: 0, credit: 4000, explanation: '银行减少。' }],
  ...
  { date: '2026-06-26', role: 'accountant', title: '计提工资及折旧', tags: ["工资","资产"], difficulty: 1, tip: 'H1半年末计提工资及折旧。', description: '计提6月工资90,000元及折旧625元。半年末需确保数据准确。', entries: [{ subjectCode: '660203', summary: '计提行政部工资', debit: 25000, credit: 0, explanation: '管理费用-工资增加。' }, { subjectCode: '660103', summary: '计提销售部工资', debit: 35000, credit: 0, explanation: '销售费用增加。' }, { subjectCode: '500102', summary: '计提生产部工资', debit: 30000, credit: 0, explanation: '生产成本-直接人工增加。' }, { subjectCode: '221101', summary: '计提本月工资', debit: 0, credit: 90000, explanation: '应付职工薪酬-工资增加。' }, { subjectCode: '660205', summary: '计提折旧', debit: 625, credit: 0, explanation: '管理费用-折旧费增加。' }, { subjectCode: '1602', summary: '计提折旧', debit: 0, credit: 625, explanation: '累计折旧增加。' }], documents: [{ type: 'text', label: '半年末计提表', docTitle: '2026 年 H1 末 计 提 表', date: '2026-06-26', stampText: '财务专用章', content: '一、工资计提\n  行政部：25,000元  销售部：35,000元  生产部：30,000元\n  合计：90,000元\n\n二、折旧计提（H1累计）\n  联想台式电脑：125×5=625元（2-6月）\n  数控车床：500×3=1,500元（4-6月）\n  本月合计：625元\n\n制表：李会计  审核：赵会计主管' }]},
