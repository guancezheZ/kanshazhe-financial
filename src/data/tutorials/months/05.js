const may = [
  ...
  { date: '2026-05-18', role: 'accountant', title: '支付水电费', tags: ["费用"], difficulty: 1, tip: '水电费计入管理费。', description: '支付5月水电费4,200元。',
    entries: [{ subjectCode: '660208', summary: '水电费', debit: 4200, credit: 0, explanation: '管理费增加。' }, { subjectCode: '100201', summary: '付水电费', debit: 0, credit: 4200, explanation: '银行减少。' }],
  ...
  { date: '2026-05-23', role: 'accountant', title: '产品质量保证', tags: ["费用"], difficulty: 3, tip: '按销售额预提质保费用。', description: '销售额400,000×2%=8,000元。',
    entries: [{ subjectCode: '660106', summary: '质保费', debit: 8000, credit: 0, explanation: '销售费用增加。' }, { subjectCode: '2212', summary: '预计负债', debit: 0, credit: 8000, explanation: '预计负债增加。' }],
