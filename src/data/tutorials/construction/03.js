    ...
    documents: [
      {
        ...
        label: '租赁摊销表',
        date: '2026-03-07',
        docTitle: '塔 吊 租 赁 摊 销 表',
        content: '期间：2026年3月\n设备：塔吊（恒达办公楼工程）\n\n摊销记录：\n  预付总额：45,000元（3个月×15,000元/月）\n  1月摊销：15,000元 ✓\n  2月摊销：15,000元 ✓\n  3月摊销（本次）：15,000元 ✓\n  累计摊销：45,000元\n  预付账款余额：0元 ✅（全部摊销完毕）\n\n制表：赵会计\n审核：李会计',
        headers: [
          '项目',
          '金额/说明'
        ],
    ...
    documents: [
      {
        ...
        label: '工资计提表',
        date: '2026-03-20',
        docTitle: '2026年3月职工工资计提表',
        content: '期间：2026年3月\n\n人员明细：\n  施工人员（18人）：90,000元（主体施工人员增加）\n    - 原基础施工队15人+新增3人\n  项目部管理人员（5人）：35,000元\n  公司管理人员（4人）：25,000元\n\n费用分配：\n  合同履约成本-人工成本（施工人员）：90,000元\n  间接费用（项目部管理）：35,000元\n  管理费用（公司管理）：25,000元\n\n工资总额：150,000元\n\n制表：王人事\n审核：李会计',
        headers: [
          '项目',
          '金额/说明'
        ],
    ...
    documents: [
      {
        ...
        label: '社保公积金计提表',
        date: '2026-03-20',
        docTitle: '2026年3月社保公积金计提明细表',
        content: '期间：2026年3月\n\n社保费率（企业部分）：\n  养老保险：16.0% | 医疗保险：8.0%\n  失业保险：0.5% | 工伤保险：0.2%\n  社保合计：24.7% | 公积金：12.0%\n  总费率：36.7%\n\n分配明细：\n  施工人员（18人）：工资90,000×36.7% = 33,030元\n  项目部管理（5人）：工资35,000×36.7% = 12,845元\n  公司管理（4人）：工资25,000×36.7% = 9,175元\n  合计：55,050元\n\n其中：社保37,050元，公积金18,000元\n\n制表：赵会计\n审核：李会计',
        headers: [
          '项目',
          '金额/说明'
        ],
    ...
    documents: [
      {
        ...
        label: '成本结转表',
        date: '2026-03-25',
        docTitle: '2026年3月合同履约成本结转表',
        content: '期间：2026年3月\n项目：恒达地产办公楼工程（累计完工进度55%）\n\n成本明细结转：\n  人工成本：172,675元 ✓\n  材料成本（钢筋加工+水泥砂石）：286,000元 ✓\n  分包成本（桩基尾款）：160,000元 ✓\n  机械使用费（塔吊租赁+续租+折旧）：45,250元 ✓\n  其他直接费用：34,700元 ✓\n  合同履约成本合计：698,625元 → 转入主营业务成本 ✓\n\n收入成本配比：\n  确认收入（不含税）：1,000,000元\n  结转成本：698,625元\n  毛利：301,375元\n  毛利率：30.1%\n\n零余额确认：各成本科目余额归零 ✓\n\n制表：李会计\n审核：赵会计',
        headers: [
          '项目',
          '金额/说明'
        ],
    ...
    documents: [
      {
        ...
        content: '期间：2026年3月\n\n计税依据：\n  销项税额：90,000元\n  进项税额：37,180元（16,380+20,800）\n  应纳增值税：52,820元\n\n税率明细：\n  城建税：52,820×7% = 3,697元\n  教育费附加：52,820×3% = 1,585元\n  地方教育附加：52,820×2% = 1,056元\n  合计：6,338元\n\n制表：李会计\n审核：赵会计',
        headers: [
          '项目',
          '金额/说明'
        ],
    ...
    documents: [
      {
        ...
        content: '期间：2026年3月\n\n收入类科目结转：\n  主营业务收入：1,000,000元 → 借方转出 ✓\n\n费用类科目结转：\n  主营业务成本：698,625元 → 贷方转出 ✓\n  税金及附加：7,838元 → 贷方转出 ✓\n  管理费用：52,375元 → 贷方转出 ✓\n  财务费用（净收入）：1,300元 → 借方转出 ✓\n\n净利润计算：\n  1,000,000 - 698,625 - 7,838 - 52,375 + 1,300 = 242,462元\n  转入本年利润：242,462元 ✓\n\n各损益科目余额已归零 ✓\n\n制表：李会计\n审核：赵会计',
        headers: [
          '项目',
          '金额/说明'
        ],
    ...
    documents: [
      {
        ...
        content: '纳税期间：2026年3月\n纳税人：鼎立建筑工程有限公司\n\n一、销项税额\n  按完工进度确认收入1,000,000×9%：90,000元\n\n二、进项税额\n  采购钢筋（180,800）：16,380元\n  采购砂石（140,400）：0元（简易计税）\n  新购搅拌机：20,800元\n  进项税额合计：37,180元\n\n三、应纳税额\n  应纳：90,000 - 37,180 = 52,820元\n  本期应补：52,820元\n\n四、附加税费\n  城建税（7%）：3,697元\n  教育费附加（3%）：1,585元\n  地方教育附加（2%）：1,056元\n  附加合计：6,338元\n\n申报人：李会计\n申报日期：2026-03-31',
        headers: [
          '项目',
          '金额/说明'
        ],
