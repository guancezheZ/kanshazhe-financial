...
describe('商业企业教程数据', () => {
  ...
  it('各月任务附件数量正确', () => {
    const COMMERCIAL_EXPECTED = {
      ...
      '2026-06-28_期末结转损益': 2,
      // ----- 07月 夏日促销 -----
      '2026-07-01_采购夏季饮品（啤酒饮料矿泉水）': 3,
      '2026-07-03_采购空调/风扇（万用电器）': 3,
      '2026-07-19_采购促销赠品（洁宝日化）': 3,
      '2026-07-30_采购秋季换季商品（护肤/保湿品）': 3,
      '2026-07-02_采购冰淇淋/冷冻食品': 2,
      '2026-07-04_支付夏日促销广告费': 2,
      '2026-07-06_报销办公用品费': 2,
      '2026-07-07_美肌堂联营专柜6月结算（净额法）': 2,
      '2026-07-08_采购生鲜水果（绿源农业·9%税率）': 2,
      '2026-07-10_预付卡消费·顾客购空调': 2,
      '2026-07-13_向万用电器支付空调采购余款': 2,
      '2026-07-14_收到鑫鑫食品第二批返利款': 2,
      '2026-07-15_支付7月房租': 2,
      '2026-07-16_支付水电费': 2,
      '2026-07-17_报销差旅费（采购员赴产地考察）': 2,
      '2026-07-20_向绿源农业支付生鲜水果货款': 2,
      '2026-07-23_缴纳社保费': 2,
      '2026-07-25_缴纳增值税（6月）': 2,
      // ----- 08月 开学季 -----
      '2026-08-02_采购开学季文具用品': 3,
      '2026-08-03_采购学生用品（文化用品+体育器材）': 3,
      '2026-08-01_支付鑫鑫食品7月冷冻品货款': 2,
      '2026-08-06_报销差旅费（采购部赴义乌考察）': 2,
      '2026-08-07_美肌堂联营专柜7月结算（净额法）': 2,
      '2026-08-08_采购生鲜水果（绿源农业）': 2,
      '2026-08-16_支付水电费': 2,
      '2026-08-17_采购日用品（洁宝日化）': 2,
      '2026-08-19_收到鑫鑫食品第三季度预返利': 2,
      '2026-08-30_采购冬季取暖设备（万用电器）': 2,
      // ----- 09月 中秋国庆 -----
      '2026-09-01_采购中秋月饼礼盒（稻香村）': 3,
      '2026-09-02_采购酒水礼盒（鑫鑫食品）': 3,
      '2026-09-04_支付8月供应商欠款（万用电器+新华文具）': 3,
      '2026-09-07_企业团购月饼礼盒': 3,
      '2026-09-03_采购中秋水果礼篮': 2,
      '2026-09-05_中秋促销宣传物料采购': 2,
      '2026-09-08_中秋预付卡发售（企业团购送礼）': 2,
      '2026-09-09_中秋买赠促销（买月饼赠茶叶）': 2,
      '2026-09-10_预付卡消费（企业持卡采购）': 2,
      '2026-09-11_中秋满减促销（满500减80）': 2,
      '2026-09-15_日常零售销售（食品/日用品/文具）': 2,
      '2026-09-17_国庆预热促销（家电折扣）': 2,
      // ----- 10月 联营调整 -----
      '2026-10-05_采购秋季保暖商品（洁宝日化）': 3,
      '2026-10-03_联营专柜季度评估费计提': 2,
      '2026-10-09_新联营商入驻——收取联营保证金': 2,
      '2026-10-10_新联营商进场费收入（分期确认）': 2,
      '2026-10-11_联营专柜装修费分摊': 2,
      '2026-10-12_美肌堂9月联营款结算支付': 2,
      '2026-10-15_联营商保底差额收取（美肌堂补差）': 2,
      '2026-10-29_缴纳9月增值税及附加税费': 2,
      '2026-10-30_采购11月冬令商品（棉被/取暖器）': 2,
      // ----- 11月 双十一 -----
      '2026-11-01_采购双十一促销商品（鑫鑫食品）': 3,
      '2026-11-02_采购双十一家电数码（万用电器）': 3,
      '2026-11-04_双十一预付卡发售（企业团购送礼）': 3,
      '2026-11-05_支付10月供应商欠款': 3,
      '2026-11-03_采购双十一宣传物料': 2,
      '2026-11-06_双十一线上推广服务费': 2,
      '2026-11-07_双十一满减促销（全场满200减30）': 2,
      '2026-11-08_双十一买赠促销（买手机赠蓝牙耳机）': 2,
      '2026-11-11_双十一物流配送费（高峰期间）': 2,
      '2026-11-13_预付卡消费（双十一集中消费）': 2,
      '2026-11-14_日常零售销售汇总': 2,
      '2026-11-17_收到前欠货款（鑫源商贸+宏达贸易）': 2,
      '2026-11-18_支付双十一临时促销人员工资': 2,
      '2026-11-24_支付水电费': 2,
      // ----- 12月 年终决算 -----
      '2026-12-01_年终年货采购（鑫鑫食品-年货礼盒）': 3,
      '2026-12-03_支付11月供应商欠款': 3,
      '2026-12-02_年终备货采购（稻香村-糕点礼盒）': 2,
      '2026-12-04_年终促销销售（年货零售）': 2,
      '2026-12-05_赊销年货至企业客户（宏达贸易）': 2,
      '2026-12-09_预付卡消费（年底集中消费）': 2,
      '2026-12-11_发放工资及年终奖': 2,
      '2026-12-23_支付全年审计费': 2,
      '2026-12-26_缴纳12月增值税': 2,
    }
    const months = ['01','02','03','04','05','06','07','08','09','10','11','12']
